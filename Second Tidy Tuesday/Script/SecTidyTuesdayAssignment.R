...
###### Loading Data #####
bobross_data<- read_csv(here("Second Tidy Tuesday","Data", "bob_ross.csv")) # time to laod in the data :)
glimpse(bobross_data) 
...
bobross_data %>%
  ...
  labs(x = "season", # my x label
    ...
    plot.background = element_rect(fill = "yellow")  # not sure as to why it is not working
